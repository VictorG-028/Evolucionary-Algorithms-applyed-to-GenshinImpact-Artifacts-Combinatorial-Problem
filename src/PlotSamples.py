...
from Algorithms.Base_Classes.Build import Build
...
def plot_best_samples():
	...
	def get_information_from_sample() -> pd.DataFrame:
		...
		algorithm_names = ["GA", "GA"] + ["ES", "ES"] + ["BeesAlgorithm", "BeesAlgorithm"]
		inputs = (["first"] + ["second"]) * number_of_algorithms
		seeds = [26, 12, 25, 5, 8, 15] # Manualy pick the samples"
	...
	fig, axis = plt.subplots(number_of_algorithms, 2, figsize = (14, 7))
